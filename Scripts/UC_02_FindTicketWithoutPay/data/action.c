Action()
{
	...
	web_submit_data("login.pl", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=userSession", "Value=137587.555366545HAHHVfQpiHQVzzzHtctzcpQfQcHf", ENDITEM, 
	...
	lr_start_transaction("filling_out_payment_fields");
	...
	web_submit_data("reservations.pl", 
		...
		"Name=departDate", "Value=10/29/2023", ENDITEM, 
		"Name=arrive", "Value=Frankfurt", ENDITEM, 
		"Name=returnDate", "Value=10/30/2023", ENDITEM, 
	...
	lr_end_transaction("filling_out_payment_fields",LR_AUTO);

	lr_think_time(7);

	lr_start_transaction("select_flight_time");
	...
	web_submit_data("reservations.pl_2", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=outboundFlight", "Value=010;386;10/29/2023", ENDITEM, 
		"Name=numPassengers", "Value=1", ENDITEM, 
		"Name=advanceDiscount", "Value=0", ENDITEM, 
		"Name=seatType", "Value=Coach", ENDITEM, 
		"Name=seatPref", "Value=None", ENDITEM, 
	...
	lr_end_transaction("select_flight_time",LR_AUTO);

	lr_start_transaction("filling_out_payment_details");
